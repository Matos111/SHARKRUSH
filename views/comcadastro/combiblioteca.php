...
<body>
    ...
    <script>
        ...
        // Banco de dados de exercícios - BASTA ADICIONAR O NOME DO ARQUIVO!
                ...
                exercises: [
                    {
                        ...
                        difficulty: 'beginner',
                        duration: '3-4 séries',
                        image: 'supino-reto.jpg',  // Nome do arquivo da imagem
                        gif: 'supino-reto.gif',     // Nome do arquivo do GIF
                        instructions: [
